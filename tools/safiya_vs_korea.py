...
- переплату к нашему импорту — корейская цена плюс наши 30% по
  контейнеру. Вот это и есть ответ, выгоднее ли брать у SAFIYA или везти
  самим.
...
Запуск:
    python3 tools/safiya_vs_korea.py --import-cost 30
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--import-cost", type=float, default=30.0,
