...
SCHEDULE = [
    ...
    (1, "Последние переданные показания и последние оплаты", "Москва", "критично"),
    ...
    (2, "Сверка расчетов с поставщиками: кому должны, кто должен нам", "Москва", "критично"),

    (3, "Опись ключей: от каких помещений, у кого дубликаты", "Москва", "критично"),
    (3, "Договоры и сканы: энергоснабжение, водоснабжение, аренда", "Москва", "критично"),
    (3, "Подотчетные деньги: остаток и за что платили наличными", "Москва", "критично"),
    (3, "Порядок подачи показаний по Светланской: куда и в какие числа", "Москва", "критично"),
    (3, "Лицевой счет по Аксаковской и ссылка", "Москва", "критично"),

    (4, "Заполнить реестр контактов: все, с кем общались за год", "Москва", "критично"),
    (4, "Отдельно: мастер по ремонту арматуры, сварщик, электрик", "Москва", "важно"),
    (4, "Отдельно: воровайка, кран, вывоз мусора, приемка металла", "Москва", "важно"),
    (4, "Отдельно: таможенный брокер и перевозчики по контейнерам", "Москва", "критично"),

    (5, "Видеообход четырех объектов: что где лежит", "Москва", "важно"),
    (5, "Журнал обзвона покупателей со статусами по каждой компании", "Олеся", "критично"),
    (5, "Кому отправлены КП и фото, кто что просил, кто в переговорах", "Олеся", "критично"),
    (5, "Фотоархив оборудования", "Олеся", "важно"),

    (6, "Бренды и заводы по косметике: контакты, цены, скидки, минимальная партия", "Москва", "критично"),
    (6, "Байер, консолидатор, склад в Корее, логистика", "Москва", "критично"),
    (6, "Документы: CPNP, декларации, Честный знак", "Москва", "важно"),
    (6, "Кто присылает прайсы и как часто они обновляются", "Москва", "важно"),

    (7, "Обход Калинина вместе с новым сотрудником: счетчики, ключи, склад", "новый сотрудник", "критично"),
    (7, "Знакомство со сторожами, порядок приема смены и оплаты", "новый сотрудник", "критично"),

    (8, "Обход Светланской, Фокино, Аксаковской: где счетчики", "новый сотрудник", "критично"),
    (8, "Знакомство с подрядчиками и с экономистом ДЭК", "новый сотрудник", "важно"),
    (8, "Новый сотрудник сам снимает показания, вы проверяете", "новый сотрудник", "критично"),

    (9, "Новый сотрудник сам оплачивает воду по четырем объектам", "новый сотрудник", "критично"),
    (9, "Совместные звонки покупателям, представить Олесю", "Олеся", "важно"),

    (10, "Контрольный день: новый сотрудник работает сам, вы на связи", "новый сотрудник", "важно"),
...
def sheet_schedule(wb):
    ...
    ws["A2"] = ("Последний рабочий день — 23 сентября. Розовым отмечено то, "
                "без чего работа встанет. Отмечайте «Сделано» в желтой колонке.")
    ws["A2"].font = NOTE
